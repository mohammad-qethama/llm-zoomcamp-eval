...
def calc_price(usage):
    ...
    response.usage_metadata.prompt_token_count       # equivalent to input_tokens
    response.usage_metadata.candidates_token_count    # equivalent to output_tokens
    response.usage_metadata.total_token_count         # same concept
...
def llm_structured(
    client, instructions, user_prompt, output_type, model="gemini-3.1-flash-lite"
):
